...
It renames all the occurrences of droneswarmrl (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the droneswarmrl folder
        os.rename(
            os.path.join(root_dir_path, "exts", "droneswarmrl", "droneswarmrl"),
            os.path.join(root_dir_path, "exts", "droneswarmrl", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "droneswarmrl"), os.path.join(root_dir_path, "exts", new_name))
